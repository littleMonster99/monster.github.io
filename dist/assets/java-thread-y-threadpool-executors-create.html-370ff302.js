import{_ as e,W as n,X as i,a0 as r}from"./framework-f64bc974.js";const a={},d=r(`<h1 id="executors创建线程池" tabindex="-1"><a class="header-anchor" href="#executors创建线程池" aria-hidden="true">#</a> Executors创建线程池</h1><p>Executors类中提供的几个静态方法来创建线程池：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>Executors.newCachedThreadPool();        //创建一个缓冲池，缓冲池容量大小为Integer.MAX_VALUE
