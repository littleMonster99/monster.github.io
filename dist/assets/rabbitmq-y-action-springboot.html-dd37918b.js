import{_ as a,W as e,X as t,Y as n,Z as p,$ as i,a0 as o,D as l}from"./framework-f64bc974.js";const c={},u=o(`<h1 id="springboot集成rabbitmq-spring-boot-starter-amqp" tabindex="-1"><a class="header-anchor" href="#springboot集成rabbitmq-spring-boot-starter-amqp" aria-hidden="true">#</a> SpringBoot集成RabbitMQ（spring-boot-starter-amqp）</h1><h2 id="_1-简介" tabindex="-1"><a class="header-anchor" href="#_1-简介" aria-hidden="true">#</a> 1. 简介</h2><p><strong>主要作用</strong>：解耦</p><p><strong>最标准的用法</strong>：</p><ul><li>生产者生产消息队列</li><li>消费者从队列中拿取消息并处理</li></ul><p>生产者不用关系是谁来消费，消费者不用关心谁在生产消息，从而达到解耦的目的</p><p>**分布式系统中的应用：**分布式事务的支持，RPC的调用等等</p><h2 id="_2-spring-boot-集成-rabbitmq" tabindex="-1"><a class="header-anchor" href="#_2-spring-boot-集成-rabbitmq" aria-hidden="true">#</a> 2. Spring Boot 集成 RabbitMQ</h2><p>Spring Boot 集成 RabbitMQ 非常简单，如果只是简单的使用配置非常少，Spring Boot 提供了<code>spring-boot-starter-amqp</code> 项目对消息各种支持。</p><h3 id="_2-1-简单使用" tabindex="-1"><a class="header-anchor" href="#_2-1-简单使用" aria-hidden="true">#</a> 2.1 简单使用</h3><p>1、配置 Pom 包，主要是添加 <code>spring-boot-starter-amqp</code> 的支持</p><div class="language-xml line-numbers-mode" data-ext="xml"><pre class="language-xml"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>dependency</span><span class="token punctuation">&gt;</span></span>
