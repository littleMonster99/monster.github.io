import{_ as i,W as l,X as o,Y as n,Z as s,$ as e,a0 as t,D as c}from"./framework-f64bc974.js";const p={},u=t(`<h1 id="kafka-安装" tabindex="-1"><a class="header-anchor" href="#kafka-安装" aria-hidden="true">#</a> Kafka - 安装</h1><h2 id="_1-安装" tabindex="-1"><a class="header-anchor" href="#_1-安装" aria-hidden="true">#</a> 1. 安装</h2><h3 id="_1-1-docker-compose-安装" tabindex="-1"><a class="header-anchor" href="#_1-1-docker-compose-安装" aria-hidden="true">#</a> 1.1 docker-compose 安装</h3><h4 id="_1-1-1-docker-compose-yml-编写" tabindex="-1"><a class="header-anchor" href="#_1-1-1-docker-compose-yml-编写" aria-hidden="true">#</a> 1.1.1 docker-compose.yml 编写</h4><div class="language-yaml line-numbers-mode" data-ext="yml"><pre class="language-yaml"><code><span class="token key atrule">version</span><span class="token punctuation">:</span> <span class="token string">&#39;3&#39;</span>
