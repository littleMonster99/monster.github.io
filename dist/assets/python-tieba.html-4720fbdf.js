import{_ as a,W as e,X as t,Y as n,Z as p,$ as i,a0 as l,D as o}from"./framework-f64bc974.js";const c={},u=l(`<h2 id="python爬取百度贴吧-难度1星" tabindex="-1"><a class="header-anchor" href="#python爬取百度贴吧-难度1星" aria-hidden="true">#</a> python爬取百度贴吧（难度1星）</h2><h2 id="_1-简介" tabindex="-1"><a class="header-anchor" href="#_1-简介" aria-hidden="true">#</a> 1. 简介</h2><p>指定贴吧名和需要的条数，将贴吧内容下载到本地</p><h2 id="_2-涉及知识点" tabindex="-1"><a class="header-anchor" href="#_2-涉及知识点" aria-hidden="true">#</a> 2. 涉及知识点</h2><ul><li>requests 发起网络请求</li><li>python文件操作 <ul><li>open() 函数用于打开一个文件，创建一个 <strong>file</strong> 对象，相关的方法才可以调用它进行读写。</li><li>f.write(&quot;hello\\n&quot;)：写入数据</li></ul></li></ul><h2 id="_3-完整代码" tabindex="-1"><a class="header-anchor" href="#_3-完整代码" aria-hidden="true">#</a> 3. 完整代码</h2><div class="language-python line-numbers-mode" data-ext="py"><pre class="language-python"><code><span class="token comment">#!/usr/bin/python3</span>
