import{_ as n,W as s,X as a,a0 as e}from"./framework-f64bc974.js";const i={},t=e(`<h1 id="aspose-word文档格式转换" tabindex="-1"><a class="header-anchor" href="#aspose-word文档格式转换" aria-hidden="true">#</a> aspose.word文档格式转换</h1><h2 id="_1-简介" tabindex="-1"><a class="header-anchor" href="#_1-简介" aria-hidden="true">#</a> 1. 简介</h2><p>aspose.word文档格式转换非常方便，如果只有一份文件（如docx，pdf等）直接调用save方法即可。如果是多页的，我们可以借助SaveOptions 实现。如图片</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token class-name">ImageSaveOptions</span> iso <span class="token operator">=</span> <span class="token keyword">new</span> <span class="token class-name">ImageSaveOptions</span><span class="token punctuation">(</span><span class="token class-name">SaveFormat</span><span class="token punctuation">.</span><span class="token constant">JPEG</span><span class="token punctuation">)</span><span class="token punctuation">;</span>
