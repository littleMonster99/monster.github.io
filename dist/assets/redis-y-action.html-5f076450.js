import{_ as n,W as s,X as a,a0 as p}from"./framework-f64bc974.js";const t={},e=p(`<h1 id="springboot集成redis项目范例" tabindex="-1"><a class="header-anchor" href="#springboot集成redis项目范例" aria-hidden="true">#</a> SpringBoot集成redis项目范例</h1><h2 id="_1-基础步骤" tabindex="-1"><a class="header-anchor" href="#_1-基础步骤" aria-hidden="true">#</a> 1. 基础步骤</h2><ol><li><p>maven添加redis依赖</p><div class="language-xml line-numbers-mode" data-ext="xml"><pre class="language-xml"><code><span class="token comment">&lt;!--redis依赖配置--&gt;</span>
