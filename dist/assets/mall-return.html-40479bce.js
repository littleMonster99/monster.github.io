import{_ as n,W as s,X as a,a0 as t}from"./framework-f64bc974.js";const p={},e=t(`<h1 id="mall中退货设计" tabindex="-1"><a class="header-anchor" href="#mall中退货设计" aria-hidden="true">#</a> mall中退货设计</h1><h2 id="_1-简介" tabindex="-1"><a class="header-anchor" href="#_1-简介" aria-hidden="true">#</a> 1. 简介</h2><p>退货也是在商城系统中的一部分，</p><h2 id="_2-流程" tabindex="-1"><a class="header-anchor" href="#_2-流程" aria-hidden="true">#</a> 2. 流程</h2><h3 id="_2-1-客户端发起退货申请" tabindex="-1"><a class="header-anchor" href="#_2-1-客户端发起退货申请" aria-hidden="true">#</a> 2.1 客户端发起退货申请</h3><p>退货是针对每一件商品的、（每一件商品在下单时，要计算单件商品实际支付的金额，在退货时才知道每件商品应该退多少金额）</p><p>退货申请的参数</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token keyword">public</span> <span class="token keyword">class</span> <span class="token class-name">OmsOrderReturnApply</span> <span class="token keyword">implements</span> <span class="token class-name">Serializable</span> <span class="token punctuation">{</span>
