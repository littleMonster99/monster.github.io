import{_ as t,W as c,X as p,Y as n,Z as s,$ as e,a0 as i,D as o}from"./framework-f64bc974.js";const l={},u=n("h1",{id:"easyexcel基础使用",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#easyexcel基础使用","aria-hidden":"true"},"#"),s(" EasyExcel基础使用")],-1),d={href:"https://www.yuque.com/easyexcel/doc/read",target:"_blank",rel:"noopener noreferrer"},r=n("h2",{id:"_1-简介",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#_1-简介","aria-hidden":"true"},"#"),s(" 1. 简介")],-1),k=n("p",null,"excel 的读取，写入在项目中也是非常常用的功能",-1),v={href:"https://github.com/alibaba/easyexcel",target:"_blank",rel:"noopener noreferrer"},m={href:"https://www.yuque.com/easyexcel/doc/easyexcel",target:"_blank",rel:"noopener noreferrer"},b=i(`<h2 id="_2-添加依赖" tabindex="-1"><a class="header-anchor" href="#_2-添加依赖" aria-hidden="true">#</a> 2. 添加依赖</h2><div class="language-pom line-numbers-mode" data-ext="pom"><pre class="language-pom"><code>&lt;dependency&gt;
