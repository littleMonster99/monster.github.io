import{_ as l,W as d,X as s,Y as i,Z as e,$ as a,a0 as r,D as v}from"./framework-f64bc974.js";const t={},c=i("h1",{id:"android调用js方法",tabindex:"-1"},[i("a",{class:"header-anchor",href:"#android调用js方法","aria-hidden":"true"},"#"),e(" Android调用js方法")],-1),u={href:"https://www.jianshu.com/p/345f4d8a5cfa",target:"_blank",rel:"noopener noreferrer"},b=r(`<p>对于Android调用JS代码的方法有2种：</p><ol><li>通过<code>WebView</code>的<code>loadUrl（）</code></li><li>通过<code>WebView</code>的<code>evaluateJavascript（）</code></li></ol><p>##方式1：通过<code>WebView</code>的<code>loadUrl（）</code></p><p><strong>步骤1：将需要调用的JS代码以.html格式放到src/main/assets文件夹里</strong></p><p><em>需要加载JS代码：javascript.html</em></p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>// 文本名：javascript
&lt;!DOCTYPE html&gt;
&lt;html&gt;
