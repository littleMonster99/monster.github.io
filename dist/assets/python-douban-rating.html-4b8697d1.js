import{_ as n,W as s,X as a,a0 as t}from"./framework-f64bc974.js";const p={},e=t(`<h1 id="python爬取豆瓣影评分析" tabindex="-1"><a class="header-anchor" href="#python爬取豆瓣影评分析" aria-hidden="true">#</a> python爬取豆瓣影评分析</h1><h2 id="_1-简介" tabindex="-1"><a class="header-anchor" href="#_1-简介" aria-hidden="true">#</a> 1. 简介</h2><p>读取豆瓣影评，并根据影评分析出影评关键词</p><h2 id="_2-涉及知识点" tabindex="-1"><a class="header-anchor" href="#_2-涉及知识点" aria-hidden="true">#</a> 2. 涉及知识点</h2><ol><li><p>requests.Session() 会话保持</p><blockquote><p>requests库的session会话对象可以跨请求保持某些参数，说白了，就是比如你使用session成功的登录了某个网站，则在再次使用该session对象求求该网站的其他网页都会默认使用该session之前使用的cookie等参数</p></blockquote></li><li><p>requests 请求网络代理</p><p>如果需要使用代理，你可以通过为任意请求方法提供 proxies 参数来配置单个请求:</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>import requests 
