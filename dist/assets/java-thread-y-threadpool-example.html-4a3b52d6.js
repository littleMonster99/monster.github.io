import{_ as n,W as i,X as e,a0 as s}from"./framework-f64bc974.js";const l={},d=s(`<h1 id="线程池使用示例" tabindex="-1"><a class="header-anchor" href="#线程池使用示例" aria-hidden="true">#</a> 线程池使用示例</h1><p>具体使用示例</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>public class Test {
