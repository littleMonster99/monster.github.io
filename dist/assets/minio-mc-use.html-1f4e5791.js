import{_ as t,W as c,X as l,Y as n,Z as s,$ as e,a0 as i,D as o}from"./framework-f64bc974.js";const d={},r=i(`<h1 id="minio客户端mc使用" tabindex="-1"><a class="header-anchor" href="#minio客户端mc使用" aria-hidden="true">#</a> Minio客户端mc使用</h1><h2 id="_1-简介" tabindex="-1"><a class="header-anchor" href="#_1-简介" aria-hidden="true">#</a> 1. 简介</h2><p>MinIO Client (mc)为ls，cat，cp，mirror，diff，find等UNIX命令提供了一种替代方案。它支持文件系统和兼容Amazon S3的云存储服务（AWS Signature v2和v4）。</p><div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token function">ls</span> 列出文件和文件夹。
mb 创建一个存储桶或一个文件夹。
