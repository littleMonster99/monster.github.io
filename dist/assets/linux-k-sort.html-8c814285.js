import{_ as n,W as s,X as e,a0 as a}from"./framework-f64bc974.js";const i={},l=a(`<h1 id="sort排序命令" tabindex="-1"><a class="header-anchor" href="#sort排序命令" aria-hidden="true">#</a> sort排序命令</h1><h2 id="_1-简介" tabindex="-1"><a class="header-anchor" href="#_1-简介" aria-hidden="true">#</a> 1 简介</h2><p>sort命令是帮我们依据不同的数据类型进行排序</p><blockquote><p>sort可针对文本文件的内容，以行为单位来排序。</p></blockquote><h2 id="_2-语法" tabindex="-1"><a class="header-anchor" href="#_2-语法" aria-hidden="true">#</a> 2 语法</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>sort [-bcfMnrtk][源文件][-o 输出文件] 
