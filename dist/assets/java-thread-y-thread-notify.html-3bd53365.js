import{_ as n,W as s,X as a,a0 as t}from"./framework-f64bc974.js";const e={},p=t(`<h1 id="线程通信-等待通知wait-notify机制" tabindex="-1"><a class="header-anchor" href="#线程通信-等待通知wait-notify机制" aria-hidden="true">#</a> 线程通信(等待通知wait/notify机制)</h1><h2 id="_1-等待-通知机制介绍" tabindex="-1"><a class="header-anchor" href="#_1-等待-通知机制介绍" aria-hidden="true">#</a> 1. 等待/通知机制介绍</h2><h3 id="_1-1-不使用等待-通知机制-轮询" tabindex="-1"><a class="header-anchor" href="#_1-1-不使用等待-通知机制-轮询" aria-hidden="true">#</a> 1.1 不使用等待/通知机制（轮询）</h3><p>当两个线程之间存在<strong>生产者和消费者关系</strong>，也就是说<strong>第一个线程（生产者）做相应的操作然后第二个线程（消费者）感知到了变化又进行相应的操作</strong></p><h4 id="_1-1-1-轮询方式案例" tabindex="-1"><a class="header-anchor" href="#_1-1-1-轮询方式案例" aria-hidden="true">#</a> 1.1.1 轮询方式案例</h4><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code> <span class="token keyword">while</span><span class="token punctuation">(</span>value<span class="token operator">=</span>desire<span class="token punctuation">)</span><span class="token punctuation">{</span>
