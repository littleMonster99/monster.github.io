import{_ as n,W as s,X as a,a0 as t}from"./framework-f64bc974.js";const e={},p=t(`<h1 id="threadlocal使用场景" tabindex="-1"><a class="header-anchor" href="#threadlocal使用场景" aria-hidden="true">#</a> ThreadLocal使用场景</h1><h2 id="_1-场景" tabindex="-1"><a class="header-anchor" href="#_1-场景" aria-hidden="true">#</a> 1. 场景</h2><h3 id="_1-1-多数据源情况" tabindex="-1"><a class="header-anchor" href="#_1-1-多数据源情况" aria-hidden="true">#</a> 1.1 多数据源情况</h3><p>我们项目中如果存在多数据源的情况。为了不影响其他线程的数据源情况。我们切换的时候。一般会使用ThreadLocal 存储当前数据源</p><div class="language-java line-numbers-mode" data-ext="java"><pre class="language-java"><code><span class="token doc-comment comment">/**
 * 数据源切换处理
 * 
