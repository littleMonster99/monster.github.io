import{_ as a,W as e,X as t,Y as n,Z as p,$ as c,a0 as o,D as i}from"./framework-f64bc974.js";const l={},u=o(`<h1 id="threadlocal" tabindex="-1"><a class="header-anchor" href="#threadlocal" aria-hidden="true">#</a> ThreadLocal</h1><h2 id="_1-什么是threadlocal" tabindex="-1"><a class="header-anchor" href="#_1-什么是threadlocal" aria-hidden="true">#</a> 1. 什么是ThreadLocal</h2><p>我们先来看下JDK 的文档介绍</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>/**
