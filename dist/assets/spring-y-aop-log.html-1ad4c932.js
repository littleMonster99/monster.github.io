import{_ as e,W as i,X as n,a0 as s}from"./framework-f64bc974.js";const l={},d=s(`<h1 id="aop打印日志" tabindex="-1"><a class="header-anchor" href="#aop打印日志" aria-hidden="true">#</a> AOP打印日志</h1><h2 id="_1-log-注解" tabindex="-1"><a class="header-anchor" href="#_1-log-注解" aria-hidden="true">#</a> 1. @Log 注解</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>@Target(ElementType.METHOD)
