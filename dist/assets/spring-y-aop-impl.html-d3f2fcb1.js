import{_ as c,W as p,X as o,Y as n,Z as s,$ as a,a1 as r,a0 as e,D as t}from"./framework-f64bc974.js";const d={},u=e('<h1 id="spring-aop实现原理" tabindex="-1"><a class="header-anchor" href="#spring-aop实现原理" aria-hidden="true">#</a> Spring AOP实现原理</h1><h2 id="_1-代理模式" tabindex="-1"><a class="header-anchor" href="#_1-代理模式" aria-hidden="true">#</a> 1. 代理模式</h2><p>代理模式UML 类图如下</p><figure><img src="https://zszblog.oss-cn-beijing.aliyuncs.com/zszblog/blogimage-master/img/image-20191011005747639.png" alt="image-20191011005747639" tabindex="0" loading="lazy"><figcaption>image-20191011005747639</figcaption></figure>',4),v=n("p",null,"类图中虚线箭头表示接口实现",-1),m=n("p",null,"菱形和箭头表示组合",-1),b=e(`<p>代理类实现了被代理类的接口，同时与被代理类是组合关系。下面看一下代理模式的实现</p><h2 id="_2-静态代理" tabindex="-1"><a class="header-anchor" href="#_2-静态代理" aria-hidden="true">#</a> 2. 静态代理</h2><p>接口类：</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>interface Person {
    void speak();
}
