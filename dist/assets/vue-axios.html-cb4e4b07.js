import{_ as n,W as s,X as d,Y as e,Z as l,$ as r,a0 as a,D as v}from"./framework-f64bc974.js";const u={},c=a(`<h1 id="axios网络请求封装" tabindex="-1"><a class="header-anchor" href="#axios网络请求封装" aria-hidden="true">#</a> axios网络请求封装</h1><h2 id="_1-axios封装" tabindex="-1"><a class="header-anchor" href="#_1-axios封装" aria-hidden="true">#</a> 1. axios封装</h2><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>/**axios封装
 * 请求拦截、相应拦截、错误统一处理
 */
