import{_ as t,W as l,X as p,Y as n,Z as s,$ as e,a0 as i,D as o}from"./framework-f64bc974.js";const c={},u=n("h1",{id:"flex布局-圣杯布局",tabindex:"-1"},[n("a",{class:"header-anchor",href:"#flex布局-圣杯布局","aria-hidden":"true"},"#"),s(" flex布局-圣杯布局")],-1),r={href:"https://en.wikipedia.org/wiki/Holy_Grail_(web_design)",target:"_blank",rel:"noopener noreferrer"},d=i(`<figure><img src="https://zszblog.oss-cn-beijing.aliyuncs.com/zszblog/blogimage-master/img/bg2015071323.png" alt="img" tabindex="0" loading="lazy"><figcaption>img</figcaption></figure><p>HTML代码如下。</p><div class="language-markup line-numbers-mode" data-ext="markup"><pre class="language-markup"><code><span class="token tag"><span class="token tag"><span class="token punctuation">&lt;</span>body</span> <span class="token attr-name">class</span><span class="token attr-value"><span class="token punctuation attr-equals">=</span><span class="token punctuation">&quot;</span>HolyGrail<span class="token punctuation">&quot;</span></span><span class="token punctuation">&gt;</span></span>
