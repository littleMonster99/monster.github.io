import{_ as r,W as a,X as d,Y as e,Z as n,$ as l,a0 as s,D as t}from"./framework-f64bc974.js";const o={},c=s(`<h1 id="solr倒排索引原理" tabindex="-1"><a class="header-anchor" href="#solr倒排索引原理" aria-hidden="true">#</a> Solr倒排索引原理</h1><h2 id="_1-简介" tabindex="-1"><a class="header-anchor" href="#_1-简介" aria-hidden="true">#</a> 1. 简介</h2><p>solr是基于Lucence开发的企业级搜索引擎技术，而lucence的原理是倒排索引。那么什么是倒排索引呢？</p><h3 id="_1-1-正排索引" tabindex="-1"><a class="header-anchor" href="#_1-1-正排索引" aria-hidden="true">#</a> 1.1 正排索引</h3><p>我们传统的方式（正排索引）是从关键点出发，然后再通过关键点找到关键点代表的信息中能够满足搜索条件的特定信息，既通过<strong>KEY寻找VALUE</strong>。</p><p>例如我们sql 语句，他是通过key ,来找值</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>where name like &#39;%张三%&#39;
