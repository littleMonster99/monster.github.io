import{_ as i,W as l,X as r,Y as e,Z as s,$ as a,a0 as t,D as c}from"./framework-f64bc974.js";const d={},o=t(`<h1 id="关闭eslint" tabindex="-1"><a class="header-anchor" href="#关闭eslint" aria-hidden="true">#</a> 关闭eslint</h1><h2 id="_1-vue-cli脚手架的关闭方法" tabindex="-1"><a class="header-anchor" href="#_1-vue-cli脚手架的关闭方法" aria-hidden="true">#</a> 1. vue-cli脚手架的关闭方法</h2><p><code>build/webpack.base.conf.js</code> 配置文件中的eslint rules注释掉</p><div class="language-html line-numbers-mode" data-ext="html"><pre class="language-html"><code>module: {
    rules: [
      // {
      //   test: /\\.(js|vue)$/,
