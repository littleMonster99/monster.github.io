import{_ as n,W as s,X as a,a0 as t}from"./framework-f64bc974.js";const e={},p=t(`<h1 id="springboot-starter-权限白名单自动化配置" tabindex="-1"><a class="header-anchor" href="#springboot-starter-权限白名单自动化配置" aria-hidden="true">#</a> SpringBoot-Starter - 权限白名单自动化配置</h1><h2 id="_1-自定义步骤" tabindex="-1"><a class="header-anchor" href="#_1-自定义步骤" aria-hidden="true">#</a> 1. 自定义步骤</h2><h3 id="_1-1-引入springboot-自动化配置依赖" tabindex="-1"><a class="header-anchor" href="#_1-1-引入springboot-自动化配置依赖" aria-hidden="true">#</a> 1.1 引入SpringBoot 自动化配置依赖</h3><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>&lt;dependency&gt;
