import{_ as l,W as t,X as r,Y as s,Z as n,$ as e,a0 as i,D as o}from"./framework-f64bc974.js";const c={},p=i('<h1 id="shell入门" tabindex="-1"><a class="header-anchor" href="#shell入门" aria-hidden="true">#</a> shell入门</h1><h2 id="_1-简介" tabindex="-1"><a class="header-anchor" href="#_1-简介" aria-hidden="true">#</a> 1. 简介</h2><p>Shell 是一个命令解释器，它为用户提供了一个向 Linux 内核发送请求以便运行程序界面系统级程序，用户可以用 Shell 来启动、挂起、停止甚至是编写一些程序。</p><figure><img src="https://zszblog.oss-cn-beijing.aliyuncs.com/zszblog/image-20220330153029197.png" alt="image-20220330153029197" tabindex="0" loading="lazy"><figcaption>image-20220330153029197</figcaption></figure><h2 id="_2-shell-编程快速入门" tabindex="-1"><a class="header-anchor" href="#_2-shell-编程快速入门" aria-hidden="true">#</a> 2. <strong>Shell 编程快速入门</strong></h2>',5),d={href:"http://hello.sh",target:"_blank",rel:"noopener noreferrer"},u=i(`<div class="language-bash line-numbers-mode" data-ext="sh"><pre class="language-bash"><code><span class="token shebang important">#!/bin/bash </span>
