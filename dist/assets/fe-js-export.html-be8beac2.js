import{_ as i,W as o,X as n,Y as e,Z as s,$ as r,a0 as a,D as l}from"./framework-f64bc974.js";const t={},c=a(`<h1 id="js导出-exports、module-exports-和-export、export-default" tabindex="-1"><a class="header-anchor" href="#js导出-exports、module-exports-和-export、export-default" aria-hidden="true">#</a> js导出：exports、module.exports 和 export、export default</h1><h2 id="_1-前言" tabindex="-1"><a class="header-anchor" href="#_1-前言" aria-hidden="true">#</a> 1. 前言</h2><p>js导入导出有多种方式，新手常常被绕得晕头转向</p><p>它们的使用范围</p><ul><li><p><code>require</code>: node 支持的引入</p></li><li><p><code>module.exports / exports</code>: 只有 node 支持的导出</p></li><li><p><code>export / import</code> : 只有es6 支持的导出引入\`</p></li></ul><blockquote><p>我们大部分在vue中使用的是es6 <code>export / import</code> 的导入导出，</p><p>如导出api:</p><p>​ let api{</p><p>​ // 网络请求</p><p>​ }</p><p>export default api;</p><p>导入：</p><p>import api from &#39;../api/myapi&#39;;</p></blockquote><h2 id="_2-node模块" tabindex="-1"><a class="header-anchor" href="#_2-node模块" aria-hidden="true">#</a> 2.node模块</h2><p><code>Node</code>里面的模块系统遵循的是<code>CommonJS</code>规范。 那问题又来了，什么是<code>CommonJS</code>规范呢？ 由于<code>js</code>以前比较混乱，各写各的代码，没有一个模块的概念，而这个规范出来其实就是对模块的一个定义。</p><blockquote><p><code>CommonJS</code>定义的模块分为: 模块标识(<code>module</code>)、模块定义(<code>exports</code>) 、模块引用(<code>require</code>)</p></blockquote><p>先解释 <code>exports</code> 和 <code>module.exports</code> 在一个node执行一个文件时，会给这个文件内生成一个 <code>exports</code>和<code>module</code>对象， 而<code>module</code>又有一个<code>exports</code>属性。他们之间的关系如下图，都指向一块{}内存区域。</p><div class="language-text line-numbers-mode" data-ext="text"><pre class="language-text"><code>exports = module.exports = {};
